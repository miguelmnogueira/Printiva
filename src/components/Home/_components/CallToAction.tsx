...
const CallToAction = () => {
	return (
		<div className="font-poppins  md:w-[80%] flex flex-col gap-2 ">
			...
			<BlurFade delay={0.25 * 2} duration={1}>
			...
			<BlurFade delay={0.25 * 3} duration={1}>
				<div className="flex flex-col md:flex-row gap-2 md:gap-5 items-center mt-5 font-inter">
					...
					<Link
						...
						smooth={`500`}
						offset={-130}
						className="h-10 flex items-center text-primary/65 text-[16px]  gap-2 hover:ml-0.5 hover:gap-2.5 hover:text-primary/90 transition-all"
					>
